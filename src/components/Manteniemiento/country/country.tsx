...
import {
  ...
  postCities,
  postDepartments,
} from "../../../services/api/CountryServices/countryService";
...
const Country: React.FC = () => {
    ...
    const fetchCountry = async () => {
      try {
        ...
        const updatedCombined = combined.map((department) => {
          const cities = citiesData.find(
            (city) => city.departmentId === department.id
          );
          return {
            ...department,
  ...
  return (
    <Container maxWidth="lg">
      <GeneralDashboard
        title="Creacion de cuidad y departamento"
        routes={AppRouter}
      >
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                error={
                  formik.touched.codeDepartment &&
                  Boolean(formik.errors.codeDepartment)
                }
                helperText={
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                error={
                  formik.touched.codeCities && Boolean(formik.errors.codeCities)
                }
                helperText={
