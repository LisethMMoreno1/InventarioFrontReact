...
import {
  ...
  getRoles,
  postRoles,
} from "../../../services/api/RolesService/rolesService";
...
const Roles: React.FC = () => {
  ...
  const handleDeleteClick = async (role: RolesInter) => {
    try {
      ...
      showErrorAlert(
        `Hubo un problema al eliminar el tipo de rol ${role.typeOfRole}`
      );
    }
  };
  ...
  return (
    <Container maxWidth="lg">
      <GeneralDashboard title="Registrar Roles" routes={AppRouter}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                error={
                  formik.touched.typeOfRole && Boolean(formik.errors.typeOfRole)
                }
                helperText={
