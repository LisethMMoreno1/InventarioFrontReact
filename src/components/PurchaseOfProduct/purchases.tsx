...
const Purchase: React.FC = () => {
  ...
  return (
    <Container maxWidth={"lg"}>
      <GeneralDashboard title="Registrar de Compra" routes={AppRouter}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField
                ...
                helperText={
                  formik.touched.customerIdentificationNumber &&
                  formik.errors.customerIdentificationNumber
                    ? formik.errors.customerIdentificationNumber
                    : ""
                }
                error={
                  formik.touched.customerIdentificationNumber &&
                  Boolean(formik.errors.customerIdentificationNumber)
                }
              />
            </Grid>
